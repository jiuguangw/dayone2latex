...
for entry in dayone_entries['entries']:
    ...
    # Tex file name
    str_entry_creationDate_filename = str_entry_folder + \
        "/" + str_entry_creationDate_heading + '.tex'
    ...
    with open(str_entry_creationDate_filename, 'w', encoding='utf-8') as file:
        ...
        if entry.get('location'):
            ...
            if entry_location.get('localityName') and entry_location.get('administrativeArea') and entry_location.get('country'):
                file.write(', ')
        ...
        if entry.get('weather'):
            ...
            if entry_weather.get('temperatureCelsius') and entry_weather.get('conditionsDescription'):
